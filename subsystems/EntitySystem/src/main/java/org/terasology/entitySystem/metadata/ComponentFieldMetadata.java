 ...
 *
 */
public class ComponentFieldMetadata<T extends Component, U> extends ExtendableFieldMetadata<T, U> {

    private boolean ownedReference;

    private CopyStrategy<U> copyWithOwnedEntitiesStrategy;

    public ComponentFieldMetadata(ClassMetadata<T, ?> owner, Field field, CopyStrategyLibrary copyStrategyLibrary, ReflectFactory factory)
